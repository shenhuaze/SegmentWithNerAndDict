package com.huaze.shen.dl.ruleparser;
...
public class RuleEntityParserFactory {
    ...
    private static final Pattern phonePattern = Pattern.compile("(?:(132|130|131|134|135|136|137|138|139|147|148" +
            "|150|151|152|157|155|156|158|159|172|178|182|183|184|187|188|198|133|149|153|173|174|177|180|181" +
            "|189|199|170|176|186|185)[0-9]{8})|(?:[0-9]{3,4}-[0-9]{8})");

    private static final Pattern emailPattern = Pattern.compile("\\w+@\\w+\\.\\w+");
    private static final Pattern urlPattern = Pattern.compile("(https?|ftp|file)://[a-zA-z0-9./#?=&+%\\-]+");
